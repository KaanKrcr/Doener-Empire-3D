...
- **Heimat-Repo: `Doener-Empire-3D`** (Unity-Projekt als Unterordner `unity/`).
  Hier liegen auch das Design-Bild und der Redesign-Brief.
- Die Flutter-App bleibt als Referenz für Logik & Balancing erhalten, wird aber
  nicht parallel weiterentwickelt, sobald die Unity-Version trägt.
